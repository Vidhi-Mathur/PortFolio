    ...
    return (
        <div className="flex flex-col justify-center items-center min-h-screen text-left sm:pl-8 md:pl-16 lg:pl-20 pt-20 sm:pt-24 md:pt-28 lg:pt-36">
            ...
            <motion.p className="text-3xl sm:text-4xl md:text-5xl  text-[#9374e8] opacity-80" animate={bounceVariants.animate} transition={bounceVariants.transition}>A FULLSTACK DEVELOPER</motion.p>
                <motion.div variants={typewriterVariants} initial="hidden" animate={isVisible ? "visible" : "hidden"} className="text-center overflow-hidden whitespace-nowrap text-white text-2xl mt-8">
